...
$filePath = "$toolsPath\dotnet-core-uninstall-0.0.0.msi"
...
# $url        = 'https://github.com/dotnet/cli-lab/releases/download/1.6.0/dotnet-core-uninstall-1.6.0.msi' # download url, HTTPS preferred
...
#   url           = $url
  ...
  softwareName  = 'Microsoft .NET Core SDK Uninstall Tool*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
